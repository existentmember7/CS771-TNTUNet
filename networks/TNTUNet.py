...
class TNTUNet(nn.Module):
    def __init__(
        ...
        self.conv2dReLU_for_input = Conv2dReLU(
            in_channels=3,
            out_channels=pixel_feature_dim,
            kernel_size=3,
            padding=1
        ...
        # CNN layer
        self.conv2dReLU_layer_1 = Conv2dReLU(
            in_channels=3,
            out_channels=pixel_feature_dim,
            kernel_size=3,
            padding=1
        ...
        self.conv2dReLU_layer_2 = Conv2dReLU(
            in_channels=512,
            out_channels=pixel_feature_dim,
            kernel_size=3,
            padding=1
        ...
        self.conv2dReLU_layer_3 = Conv2dReLU(
            in_channels=512,
            out_channels=pixel_feature_dim,
            kernel_size=3,
            padding=1
    ...
    def forward(self, x):
        # print(x.shape)
        # save_tensor_to_image(f"F:\\decoder_output\\input_x.png", x[0,:,:,:])

        output_1 = self.conv2dReLU_layer_1(x)
        output_1 = self.tnt_4_first(output_1)
        ...
        output_2 = self.conv2dReLU_layer_2(output_1)
        output_2 = self.tnt_4_second(output_2)
        ...
        output_3 = self.conv2dReLU_layer_3(output_2)
        output_3 = self.tnt_4_third(output_3)
        ...
        # print(output_decoder_1.shape)
        # for i in range(output_decoder_1.shape[1]):
        #     save_tensor_to_image(f"F:\\decoder_output\\output_decoder_1_{i}.png", output_decoder_1[:,i,:,:])
        ...
        # print(output_decoder_2.shape)
        # for i in range(output_decoder_2.shape[1]):
        #     save_tensor_to_image(f"F:\\decoder_output\\output_decoder_2_{i}.png", output_decoder_2[:,i,:,:])
        ...
        output_from_input = self.conv2dReLU_for_input(x)
        output_decoder_3 = torch.cat((output_decoder_3,output_from_input),1)
        output_decoder_3 = self.conv2dReLU(output_decoder_3)
        # print(output_decoder_3.shape)
        # for i in range(output_decoder_3.shape[1]):
        #     save_tensor_to_image(f"F:\\decoder_output\\output_decoder_3_{i}.png", output_decoder_3[:,i,:,:])
